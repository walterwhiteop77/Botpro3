...
• /details - ᴄʜᴇᴄᴋ ʏᴏᴜʀ ꜱᴇᴛᴛɪɴɢꜱ."""
    ...
    FILE_LIMIT_TEXT = """<b>👋 ʜᴇʏ {},

⚠️ ʏᴏᴜ ʜᴀᴠᴇ ʀᴇᴀᴄʜᴇᴅ ʏᴏᴜʀ ᴅᴀɪʟʏ ꜰʀᴇᴇ ꜰɪʟᴇ ʟɪᴍɪᴛ ᴏꜰ <code>{}</code> ꜰɪʟᴇꜱ.

• ᴅᴏᴡɴʟᴏᴀᴅ ᴜꜱɪɴɢ ᴛʜᴇ ʟɪɴᴋ ʙᴇʟᴏᴡ 👇
• ᴏʀ ʙᴜʏ ᴀ ᴘʀᴇᴍɪᴜᴍ ꜱᴜʙꜱᴄʀɪᴘᴛɪᴏɴ ꜰᴏʀ ᴜɴʟɪᴍɪᴛᴇᴅ ᴀᴄᴄᴇꜱꜱ.
• ʟɪᴍɪᴛ ʀᴇꜱᴇᴛꜱ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴀᴛ 23:59 ɪꜱᴛ.</b>"""
